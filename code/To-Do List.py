...
def default(task):
    if task_entry.get()=="Enter the task here":
        task_entry.delete(0,"end")
        task_entry.config(fg="red")

def event(task):
    if task_entry.get()=="":
        task_entry.insert(0,"Enter the task here")
        task_entry.config(fg="blue")
...
task_entry=tk.Entry(root,fg="blue",width=30)
task_entry.insert(0,"Enter the task here")
